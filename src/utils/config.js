export default {
  ...
  // bondsHead: {
  //   createBy: { label: '研究员id', prop: 'createBy', width: 'auto', align: 'left', show: false },
  //   tscode: { label: '券码', prop: 'tscode', formatter: this.funcFormat, width: '70', align: 'left', show: true },
  //   direction: { label: '方向', prop: 'direction', formatter: this.funcFormat, width: '50', align: 'left', show: true },
  //   price: { label: '成交价', prop: 'price', formatter: this.funcFormat, width: '66', align: 'left', show: true },
  ...
  //   deliveryTime: { label: '交割日期', prop: 'deliveryTime', formatter: this.funcFormat, width: '96', align: 'left', show: false },
